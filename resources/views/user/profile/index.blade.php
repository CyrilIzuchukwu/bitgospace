...
@section('content')
                        ...
                        <div class="card-body main-card">
                            <div class="row">
                                ...
                                <div class="col-md-4  border-end pe-md-4">
                                    <div class="text-center mb-4">
                                        <form id="profilePictureForm" action="{{ route('profile.update.picture') }}"
                                            ...
                                            <div class="position-relative d-inline-block">
                                                ...
                                                <img src="{{ $user->profile && $user->profile->profile_picture ? asset('storage/profile_pictures/' . $user->profile->profile_picture) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&size=240&background=random' }}"
                                                    class="rounded-circle shadow" width="120" height="120"
                                                    style="object-fit: cover;" alt=" Profile " id="profileImage">

                                                <label for="profile_picture"
                                                    class="btn btn-sm btn-primary position-absolute bottom-0 end-0 rounded-pill cursor-pointer">
                                        ...
                                        @if (Auth::user()->is_ambassador)
                                            <div class="mt-3 mb-3">
                                                <div class="ambassador-simple-badge">
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex justify-content-center align-items-center gap-2">
                                                        <button class="btn btn-sm btn-outline-primary"
                                                            data-bs-toggle="modal" data-bs-target="#updatePinModal">
                                                            <i class="ti ti-pencil"></i> Change PIN
                                                        </button>
                                                        <a href="{{ route('user.forgot.pin') }}"
                                                            class="btn btn-sm btn-outline-danger" id="forgotPinBtn">
                                    ...
                                    <div class="mb-4">
                                        <h6 class="fw-bold text-uppercase small text-center text-muted mb-3">Referral Link
                                        </h6>
                                        <div class="text-center p-3 bg-light rounded">
                                            ...
                                            <div class="d-flex justify-content-center gap-2 mt-2">
                                                <input type="text" id="referral_link_input"
                                                    class="form-control d-none form-control-sm w-75"
                                                    value="{{ $referralLink }}" readonly>
                                                <button class="btn btn-sm btn-outline-info" id="copy_referral_btn">Copy
                                                    Link</button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <button class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal"
                                                    data-bs-target="#changePasswordModal">Change</button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body p-3">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <p id="userPhone" class=" small text-muted mb-0">
                                                        {{ $user->profile->phone ?? 'N/A' }}</p>
                                                </div>
                                                <button class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal"
                                                    data-bs-target="#changePhoneModal">Change</button>
                                            </div>
                                        </div>
                                    </div>
    ...
    <!-- Update PIN Modal -->
    <div class="modal fade" id="updatePinModal" tabindex="-1" aria-labelledby="updatePinModalLabel"
        aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" placeholder="Enter old pin"
                                class="form-control @error('current_pin') is-invalid @enderror" id="current_pin"
                                name="current_pin" maxlength="4" pattern="\d{4}" value="{{ old('current_pin') }}"
                                required>
                            @error('current_pin')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" placeholder="Enter new pin"
                                class="form-control @error('pin') is-invalid @enderror" id="new_pin" name="pin"
                                maxlength="4" pattern="\d{4}" value="{{ old('pin') }}" required>
                            @error('pin')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" placeholder="Confirm pin"
                                class="form-control @error('pin_confirmation') is-invalid @enderror" id="confirm_pin"
                                name="pin_confirmation" maxlength="4" pattern="\d{4}" required>
            ...
            phoneForm.addEventListener('submit', async function(e) {
                ...
                try {
                    ...
                    const response = await fetch(phoneForm.action, {
                        method: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': phoneForm.querySelector('input[name="_token"]')
                                .value,
                            'Accept': 'application/json'
                        },
                        body: formData
