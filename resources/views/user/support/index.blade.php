            ...
            <div class="col-md-12">
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted w-100 m-auto">
                        Overview of all your support tickets
                    </p>
                </div>
                ...
                <div class="no-investment">
                    <div style="display: flex; align-items: end; justify-content: end;">
                        <a href="{{ route('user.create.support') }}" class="btn btn-primary bg-gradient">
                    ...
                    <div class="not-found card">
                        ...
                        <div class="text-notfound">
                            ...
                            <span class="text-gray-100">You haven't created any support tickets yet.</span>
                        </div>
                    </div>
                </div>
                @else
                                            ...
                                            <tr data-status="{{ strtolower($ticket->status) }}">
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <span class="fw-semibold fs-12">{{ $ticket->subject }}</span>
                                                        <small class="text-muted fs-10">#{{ $ticket->reference_id }}</small>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="{{ route('user.ticket.view', $ticket->reference_id) }}"
