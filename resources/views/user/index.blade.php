                        ...
                        <div class="user-dashboard-grid">
                            ...
                            <div class="card">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <h4 class="header-title">Balance</h4>
                                </div>

                                <div class="card-body pt-0">
                                    <h2 class="fw-bold d-flex align-items-center gap-1">
                                        <span id="balance-amount" class="balance-text">${{ $walletBalance ?? '0.00' }}</span>
                                        <a href="#!" class="text-muted" id="toggle-visibility">
                            ...
                            <div class="card">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <h4 class="header-title">Total Deposit</h4>

                                    <div class="box-icon deposit">
                                ...
                                <div class="card-body pt-0">
                                    <h2 class="fw-bold balance-text"> ${{ $totalDeposits ?? '0.00' }}</h2>
                                </div>
                            </div>

                            <div class="card">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <h4 class="header-title">Total Withdrawals</h4>
                                    <div class="box-icon withdrawal">
                                        <i class="ti ti-arrow-up-circle"></i>
                                    </div>
                                </div>

                                <div class="card-body pt-0">
                                    <h2 class="fw-bold balance-text">${{ $totalWithdrawals }}</h2>
                                </div>
                            </div>

                            <div class="card">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <h4 class="header-title">Referral Commission</h4>

                                    <div class="box-icon referral">
                                ...
                                <div class="card-body pt-0">
                                    <h2 class="fw-bold balance-text">${{ $totalReferralBonus }} </h2>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <h4 class="header-title">Total Investment</h4>

                                    <div class="box-icon investment">
                                        <i class="ti ti-trending-up"></i>
                                    </div>
                                </div>

                                <div class="card-body pt-0">
                                    <h2 class="fw-bold balance-text">${{ $totalInvestments }}</h2>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <h4 class="header-title">Running Investment</h4>
                                ...
                                <div class="card-body pt-0">
                                    <h2 class="fw-bold balance-text">
                                        <h2 class="fw-bold balance-text">${{ $runningInvestments }}</h2>
                                        @if($runningInvestments > 0)
                                        <small class="text-muted">{{ auth()->user()->investments()->where('due', false)->count() }} active investment</small>
                                        @endif
                                    </h2>
                                </div>
                            </div>
