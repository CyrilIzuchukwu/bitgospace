                ...
                <div class="col-lg-12">
                    <div class="inner text-center">
                        ...
                        <p class="hero-description">
                            No more staring at charts or stressing about when to buy or sell. Let BitGoSpace’s smart AI and
                            arbitrage system trade for you.
                        </p>
                    ...
                    <div class="content">
                        <div class="inner">
                            ...
                            <div class="about-inner">
                                <p>At BitGoSpace, we believe that crypto trading shouldn’t be complicated or reserved for
                                    experts. That’s why we built an intelligent, AI-driven platform that does the hard work
                                    for you spotting and executing profitable trades using arbitrage strategies.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mt-5 mb-5">
                <div class="col-lg-12">
                    <div class="section-box-title text-center sal-animate">
                        ...
                        <p class="sub-title">Let AI handle crypto arbitrage while you earn — no stress, no experience
                            needed.</p>
                    </div>
                            ...
                            <div class="rainbow-default-tab style-three">
                                <ul class="nav nav-tabs why-tabs tab-button" role="tablist">
                                    <li class="nav-item tabs__tab" role="presentation">
                                        <button class="nav-link active" id="arbitrage-tab" data-bs-toggle="tab"
                                            data-bs-target="#arbitrage" type="button" role="tab"
                                            aria-controls="arbitrage" aria-selected="true">
                                            AI-Powered Arbitrage
                                        </button>
                                    </li>
                                    <li class="nav-item tabs__tab" role="presentation">
                                        <button class="nav-link" id="secure-tab" data-bs-toggle="tab"
                                            data-bs-target="#secure" type="button" role="tab" aria-controls="secure"
                                            aria-selected="false">
                                            Secure & Simple
                                        </button>
                                    </li>
                                    <li class="nav-item tabs__tab" role="presentation">
                                        <button class="nav-link" id="trading-tab" data-bs-toggle="tab"
                                            data-bs-target="#trading" type="button" role="tab"
                                            aria-controls="trading" aria-selected="false">
                                            24/7 Smart Trading
                                        </button>
                                    </li>
                                </ul>
                                ...
                                <div class="rainbow-tab-content tab-content">
                                    <div class="tab-pane fade show active" id="arbitrage" role="tabpanel"
                                        aria-labelledby="arbitrage-tab">
                                        <div class="inner">
                                            <p><span>BitGoSpace</span> uses a smart AI arbitrage bot that watches multiple
                                                crypto exchanges at once. Whenever it sees a price difference say Bitcoin is
                                                cheaper on one platform and more expensive on another the bot quickly buys
                                                low and sells high.
                                            </p>
                                            <p>
                                                It does this automatically, without any input from you. No charts, no
                                                stress, just steady profit-making in the background.
                                                It’s like having a super-fast, tireless trader working for you 24/7 but
                                                without the salary.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="secure" role="tabpanel"
                                        ...
                                        <div class="inner">
                                            <div class="inner">
                                                <p>With <span>BitGoSpace</span>, you fund your trading account, and our AI
                                                    bot takes over from there. It automatically trades on your behalf using
                                                    smart arbitrage strategies across exchanges.
                                                    No technical skills needed just fund, activate, and let the bot do the
                                                    work.
                                                </p>
                                                <p> After the bot has completed its trades and generated returns, you can
                                                    then withdraw your profits.
                                                    You're not left guessing everything is tracked, transparent, and in your
                                                    control.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="trading" role="tabpanel"
                                        ...
                                        <div class="inner">
                                            <p>The AI arbitrage bot doesn’t sleep. It works around the clock, scanning the
                                                market nonstop, spotting price differences, and making trades in seconds.
                                            </p>
                                            <p>It keeps going while you sleep, relax, or focus on your day always looking
                                                for small, safe profits. Faster than any human trader, 100% automated.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row row--0">
                            <div class="col-lg-3 col-md-3 rainbow-timeline-single dark-line">
                                <div class="rainbow-timeline">
                                    <h6 class="title" data-sal="slide-up" data-sal-duration="400" data-sal-delay="200">
                                    ...
                                    <p class="description" data-sal="slide-up" data-sal-duration="400"
                                        data-sal-delay="300">Sign up quickly with
                            ...
                            <div class="col-lg-3 col-md-3 rainbow-timeline-single dark-line">
                                <div class="rainbow-timeline">
                                    ...
                                    <p class="description" data-sal="slide-up" data-sal-duration="400"
                                        data-sal-delay="300">Deposit funds into your BitGoSpace wallet. That’s what the bot
                                        trades with.</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 rainbow-timeline-single dark-line">
                                <div class="rainbow-timeline">
                                    ...
                                    <p class="description" data-sal="slide-up" data-sal-duration="400"
                                        data-sal-delay="300">Turn on your smart bot.
                            ...
                            <div class="col-lg-3 col-md-3 rainbow-timeline-single dark-line">
                                <div class="rainbow-timeline">
                                    ...
                                    <p class="description" data-sal="slide-up" data-sal-duration="400"
                                        data-sal-delay="300">The bot works nonstop. Once trades are done, you can withdraw
                                        your earnings.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row mb--40">
                <div class="col-lg-12">
                    <div class="section-box-title text-center sal-animate">
                        ...
                        <p class="sub-title">Everything you need to trade smarter — whether you're just starting or scaling
                            up.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-box-title text-center sal-animate">
                        ...
                        <p class="sub-title">See how <span></span> is helping people grow their profits effortlessly with
                            zero trading experience.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="">
                        <div class="">
                            <div
                                class="rainbow-slick-dot testimonial-activation rainbow-slick-arrow slick-arrow-alignwide mt--60 testimonial-content">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="content mt_sm--40">
                                                ...
                                                <p class="description">I’ve used other bots before, but
                                                    <span>BitGoSpace</span> is on another level.
                                                    It finds profitable trades fast, and I don't need to babysit it. I’ve
                                                    seen consistent returns with zero stress.
                                                </p>
                                    ...
                                    <div class="row row--20 align-items-center">
                                        ...
                                        <div class="col-lg-6 col-md-8">
                                            <div class="content mt_sm--40">
                                                <span class="form">
                                                    Canada
                                                    <img src="https://flagcdn.com/w20/ca.png" alt="Canada Flag"
                                                        width="20" height="15" style="vertical-align: middle;">
                                                </span>
                                                <p class="description">As someone new to crypto, I was nervous about
                                                    trading. BitGoSpace made it incredibly easy. I just funded my wallet,
                                                    turned on the bot, and started seeing small gains almost daily. The
                                                    dashboard is clean, and I love how transparent everything is.
                                                </p>
                                                <div class="client-info">
                                    ...
                                    <div class="row row--20 align-items-center">
                                        ...
                                        <div class="col-md-8">
                                            <div class="content mt_sm--40">
                                                ...
                                                <p class="description">I work full-time and don’t have hours to monitor
                                                    charts. BitGoSpace runs silently in the background, making smart trades
                                                    through arbitrage. The performance tracking is solid, and I stay in full
                                                    control of my funds. It’s a brilliant system.
                                                </p>
                                                <div class="client-info">
            ...
            <div class="row  mb-0 mb-md-5">
                <div class="col-lg-12">
                    <div class="section-box-title text-center sal-animate">
                        ...
                        <p class="sub-title">Find quick, clear info about how BitGoSpace works from setup to withdrawals
                            ...
                            <div class="accordion" id="accordionExamplea">
                                <div class="accordion-item card">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body card-body">
                                            BitGoSpace is an AI-powered crypto arbitrage platform that helps you earn
                                            profits automatically by buying low and selling high across different exchanges.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item card">
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body card-body">
                                            Nope! BitGoSpace was built to be beginner-friendly. Just sign up, fund your
                                            wallet, and activate the bot. It handles the rest.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item card">
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body card-body">
                                            Yes, Your funds are stored securely in your BitGoSpace wallet. Our platform uses
                                            encrypted connections, and the bot trades without needing access to your
                                            personal data.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item card">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body card-body">
                                            It scans multiple exchanges 24/7, finds price differences (arbitrage
                                            opportunities), buys crypto at a lower price on one platform, and sells higher
                                            on another automatically.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item card">
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body card-body">
                                            Yes. Once the bot completes its trade cycles, your funds and profits are
                                            available for withdrawal straight from your dashboard.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item card">
                                    ...
                                    <div id="collapseSix" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body card-body">
                                            The bot operates continuously day and night identifying multiple small-profit
                                            trades across exchanges throughout the day.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item card">
                                    ...
                                    <div id="collapseSeven" class="accordion-collapse collapse"
                                        aria-labelledby="headingSeven" data-bs-parent="#accordionExamplea">
                                        <div class="accordion-body card-body">
                                            Yes, we have a small minimum starting balance to activate your trading wallet.
                                            You’ll see the current amount when setting up your account.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item card">
                                    ...
                                    <div id="collapseEight" class="accordion-collapse collapse"
                                        aria-labelledby="headingEight" data-bs-parent="#accordionExamplea">
                                        <div class="accordion-body card-body">
                                            Absolutely. You can pause or stop your bot with a single click from your
                                            dashboard, giving you full control.
                                        </div>
                                    </div>
                                </div>
