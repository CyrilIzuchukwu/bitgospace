        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="text-center mb-4">
                    <h3 class="mb-2" style="text-transform: uppercase;">Transaction Records</h3>
                ...
                <div class="no-investment">
                    <div class="not-found card">
                        ...
                        <div class="text-notfound">
                            ...
                            <span class="text-gray-100">There are currently no transaction records.</span>
                        </div>
                    </div>
                </div>
                @else
                                    ...
                                    <table class="table table-borderless table-hover table-custom table-nowrap align-middle mb-0">
                                        <thead class="bg-light bg-opacity-50 thead-sm">
                                            <tr class="text-uppercase fs-10">
                                                ...
                                                <th scope="col" class="text-muted text-end">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr data-type="{{ $transaction->type }}" data-status="{{ $transaction->status }}">
                                                ...
                                                <td class="text-end">
                                                    <button class="btn btn-sm btn-outline-primary view-details"
                                                        ...
                                                        data-user-name="{{ $transaction->user->name }}"
                                                        data-user-email="{{ $transaction->user->email }}"
                                                        data-user-phone="{{ $transaction->user->phone ?? 'N/A' }}">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                                    <div class="avatar-lg me-3">
                                        <span class="avatar-title bg-primary-subtle text-primary rounded-circle display-5">
                                ...
                                <table class="table table-sm table-borderless">
                                    <tr>
                                        ...
                                        <td id="detail-user-phone"></td>
                                    </tr>
                                    <tr>
                                        <th>Registered:</th>
                                        <td id="detail-user-registered"></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        viewButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                // User details
                document.getElementById('detail-user-name').textContent = this.dataset.userName;
                document.getElementById('detail-user-email').textContent = this.dataset.userEmail;
                document.getElementById('detail-user-phone').textContent = this.dataset.userPhone;
                document.getElementById('detail-user-initial').textContent = this.dataset.userName.charAt(0).toUpperCase();
