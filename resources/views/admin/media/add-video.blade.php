        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="text-center mb-4">
                    <h3 class="mb-2">Upload New Video</h3>
                    <p class="text-muted w-100 w-md-75 m-auto">
                        Select your video, add details, and upload. Please ensure your file meets the required specifications.
                    </p>
                </div>
                ...
                <div class="card position-relative deposit-wrapper">
                    <div class="card-body">
                        ...
                        <!-- Upload Form -->
                        <form id="videoUploadForm" action="{{ route('admin.store-video') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <div class="border rounded p-3 text-center bg-light" id="videoDropArea" style="cursor:pointer;">
                                    <input type="file" class="form-control d-none" id="videoInput" name="video" accept="video/*" required>
                                    <div id="uploadAreaContent">
                                        <i class="ti ti-video text-primary display-6 mb-2"></i>
                                        <p class="mb-0 text-muted">Click here or drag & drop to select a video file</p>
                                    ...
                                    <div id="videoPreviewContainer" class="d-none mt-3">
                                        <video id="videoPreview" width="100%" controls style="max-height: 300px;"></video>
                                    </div>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="Add a description (optional)"></textarea>
                            ...
                            <button type="submit" class="submit-btn btn-default w-100">
                                Upload Video <i class="ti ti-upload ms-1"></i>
                            </button>
                        </form>
